      ...
      <v-flex xs12 sm12 md12>
        <v-card>
          <v-layout class="lay-des-pad grey lighten-3" row wrap>
            <v-flex xs12>
              <h3 class="head black--text">Supplier Evaluation</h3>
            </v-flex>
          </v-layout>
          <v-form ref="form" class="lay-des1 white" v-model="valid" id="emp" lazy-validation>
            ...
            <v-layout class="white" row wrap>
              <v-flex md3>
                <div class="text-rr">
                  <label class="lab-for black--text">Supplier</label>
                  <v-text-field placeholder="Enter the value" outline></v-text-field>
                </div>
              </v-flex>
              <v-flex md3>
                <div class="text-rr">
                  <label class="lab-for black--text">Country</label>
                  <v-text-field placeholder="Country" outline></v-text-field>
                </div>
              </v-flex>
              <v-flex md3>
                <div class="text-rr">
                  <label class="lab-for black--text">State</label>
                  <v-text-field label placeholder="State" outline></v-text-field>
                </div>
              </v-flex>
              <v-flex md3>
                <div class="text-rr">
                  <label class="lab-for black--text">City</label>
                  <v-text-field label placeholder="City" outline></v-text-field>
                </div>
              </v-flex>
              <v-flex md3>
                <div class="text-rr">
                  <label class="lab-for black--text">Street</label>
                  <v-text-field label placeholder="Street" outline></v-text-field>
                </div>
              </v-flex>
              <v-flex md3>
                <div class="text-rr">
                  <label class="lab-for black--text">Pin</label>
                  <v-text-field label placeholder="Pin" outline></v-text-field>
                </div>
              </v-flex>
              <v-flex md3>
                <div class="text-rr">
                  <label class="lab-for black--text">phone</label>
                  <v-text-field label placeholder="phone" outline></v-text-field>
                </div>
              </v-flex>
                            <v-flex md3>
                <div class="text-rr">
                  <label class="lab-for black--text">Email</label>
                  <v-text-field label placeholder="Email" outline></v-text-field>
                </div>
              </v-flex>
                            <v-flex md3>
                <div class="text-rr">
                  <label class="lab-for black--text">Website</label>
                  <v-text-field label placeholder="Website" outline></v-text-field>
                </div>
              </v-flex>
            </v-layout>
            <v-flex md12>
